...
class Tnet(nn.Module):
    def __init__(self, k=3):
        super().__init__()
        self.k = k
        self.conv1 = nn.Conv1d(k, 64, 5, stride=3)
        self.conv2 = nn.Conv1d(64, 128, 5, stride=3)
        self.conv3 = nn.Conv1d(128, 1024, 5, stride=3)
...
class Transform(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv1d(3, 64, 5, stride=3)
