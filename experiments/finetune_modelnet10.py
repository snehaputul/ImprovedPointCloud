...
random.seed = 42
path = Path("C:\\Users\\sneha\\Documents\\data\\ModelNet10\\ModelNet10")
...
PATH= "modelnet40_best.pth"
checkpoint = torch.load(PATH)
message = pointnet.load_state_dict(checkpoint, strict=False)
print(message)

# changing last layer according to new number of classes
pointnet.fc3 = torch.nn.Linear(256,10)
